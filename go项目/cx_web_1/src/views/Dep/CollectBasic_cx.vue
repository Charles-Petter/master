  ...
  <div>
    ...
    <div>
      <el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12">
        <el-col :span="16">
          <el-form :model="emp" :rules="rules" ref="emp" @submit.native.prevent>
            <el-form-item prop="department_name">
              <el-input placeholder="请输入学院名称" prefix-icon="el-icon-search"
                        clearable
                        @clear="initEmps"
              ...
              <el-button-group>
                <el-button plain icon="el-icon-search" type="primary" @click="searchEmp('emp')"  :disabled="showAdvanceSearchView || showDateSearchView">搜索</el-button>
                <el-button  plain icon="el-icon-refresh" type="info" @click="resetForm('emp')" :disabled="showAdvanceSearchView || showDateSearchView">刷新</el-button>
              </el-button-group>
            </el-form-item>
          </el-form>
          </el-col>
        ...
        <el-table-column prop="department_number" fixed align="left" label="学院编号" width="75" show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="department_name" fixed align="left" label="学院名称" width="75" show-overflow-tooltip>
        </el-table-column>
