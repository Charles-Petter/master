...
<!--            1.获取输入框的值-->
        ...
        <el-table-column prop="taxafter" label="交税后" align="left" width="150" sortable show-overflow-tooltip>
        </el-table-column>
        ...
        <template slot-scope="scope">
          <!--            主管上传工资-->
          <el-button @click="showEditEmpView(scope.row)" v-if="!is_director" style="padding: 3px" size="mini" type="warning">上传工资信息</el-button>
        </template>
        </el-table-column>
        </el-table>
    </div>
